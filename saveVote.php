...
<html lang="en">
  ...
  <body>
    ...
    " role="navigation">
      <div class="container">
        ...
        <div class="navbar-header">
          <a href="index.html" class="navbar-brand headerFont text-lg"><strong>PollParty</strong></a>
        </div>
    ...
    <div class="container" style="padding-top:150px;">
       ...
       $DB_HOST= "localhost";
       $DB_USER="ruksons3_scripts";
       $DB_PASSWORD="Scripts";
       $DB_NAME="ruksons3_scripts";
        ...
        or die("Couldn't Connect to Database :");
				...
				$sql= "INSERT INTO ruksons3_scripts.tbl_users VALUES(null,'".$name."','".$email."','".$voterID."','".$selection."');";
